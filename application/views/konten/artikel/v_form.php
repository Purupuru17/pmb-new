    ...
    <div class="row">
        ...
        <div class="col-xs-12">
            ...
            <form id="validation-form" action="<?= site_url($action); ?>" name="form" class="form-horizontal" method="POST" enctype="multipart/form-data">
                ...
                <div class="form-group">
                    <label class="control-label col-xs-12 col-sm-5 no-padding-right">Popular :</label>
                    <div class="col-xs-12 col-sm-7">
                        <div class="clearfix">
                            <label class="control-label">
                ...
                <div class="form-group">
                    <label class="control-label col-xs-12 col-sm-5 no-padding-right">Breaking News :</label>
                    <div class="col-xs-12 col-sm-7">
                        <div class="clearfix">
                            <label class="control-label">
                ...
                <div class="form-group">
                    ...
                    <div class="col-xs-12 col-sm-4">
                        <div class="clearfix">
                            <img width="200" class="img-thumbnail" src="<?= load_file($edit['foto_artikel']) ?>">
                        </div>
                    </div>
                </div>
                <div class="form-group">
