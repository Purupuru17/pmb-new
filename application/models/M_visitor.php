...
class M_visitor extends KZ_Model {
    ...
    protected $columns = [null, 'access_date','ip_address','no_of_visits','requested_url','page_name','user_agent'];
    protected $searchable = ['access_date','ip_address','no_of_visits','requested_url','page_name','user_agent'];
    protected $order = ['access_date' => 'desc'];
