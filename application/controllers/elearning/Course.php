...
class Course extends KZ_Controller {
    ...
    private $module = 'elearning/course';
    private $module_do = 'elearning/course_do';
    ...
    function index() {
        ...
        $this->load_view('elearning/course/v_index', $this->data);
    }
    function add($id = NULL) {
        ...
        $this->load_view('elearning/course/v_add', $this->data);
    }
    function edit($id = NULL) {
        ...
        $this->load_view('elearning/course/v_edit', $this->data);
    }
    function detail($id = NULL) {
        ...
        $this->load_view('elearning/course/v_detail', $this->data);
    }
                            ...
                            <div class="widget-header widget-header-small">
                                ...
                                <span class="widget-toolbar no-border">
                                    <div class="btn-group btn-overlap '.$is_dosen.'">
                                        <a target="_blank" href="'.site_url('elearning/jurnal/edit/'.encode($items['id_jurnal'])).'" 
                                            class="btn btn-white btn-warning btn-bold btn-mini">
                                            <i class="fa fa-pencil-square-o bigger-110"></i> Ubah
                                        </a>
                                        <a href="'.site_url('elearning/jurnal/detail/'.encode($items['id_jurnal'])).'" target="_blank" 
                                        ...
                                        <button id="delete-btn" itemid="'.site_url('elearning/jurnal/delete/'.encode($items['id_jurnal'])).'" itemname="Pertemuan Ke - '.ctk($items['init_jurnal']).'"
