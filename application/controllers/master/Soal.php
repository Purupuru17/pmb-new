...
class Soal extends KZ_Controller {
    ...
    private $module = 'master/soal';
    private $module_do = 'master/soal_do';
    ...
    function index() {
        $this->data['bank'] = $this->m_bank->getAll();
        ...
        $this->load_view('master/soal/v_index', $this->data);
    }
    function add() {
        ...
        $this->load_view('master/soal/v_form', $this->data);
    }
    ...
    function detail($id = NULL) {
        ...
        $this->load_view('master/soal/v_detail', $this->data);
    }
