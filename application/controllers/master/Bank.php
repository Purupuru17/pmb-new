...
class Bank extends KZ_Controller {
    ...
    function index() {
        ...
        $this->load_view('master/bank/v_index', $this->data);
    }
    function add() {
        ...
        $this->load_view('master/bank/v_form', $this->data);
    }
    ...
    function detail($id = NULL) {
        ...
        $this->load_view('master/bank/v_detail', $this->data);
    }
    ...
    function _table_soal() {
        ...
        foreach ($list['data'] as $val) {
            ...
            $row[] = '<div class="action-buttons">
                    <a target="_blank" href="'.site_url('master/soal/detail/' . encode($val['id_soal'])).'" 
