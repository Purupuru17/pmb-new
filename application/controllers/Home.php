...
class Home extends KZ_Controller {
    ...
    function galeri($slug = NULL) {
        ...
        if(!is_null($slug)){
            ...
            $count = $this->m_galeri->countAll(array('status_galeri' => '1', 'jenis_galeri' => '0'));
    ...
    function sitemap() {
        ...
        $artikel = $this->m_artikel->getAll(null, 'desc');
    ...
    function _artikel() {
        ...
        $result = $this->m_artikel->getAll($where, $order, $limit);
        $data = array();
        foreach ($result['data'] as $value) {
            $row = array();
    ...
    function _galeri() {
        ...
        $result = $this->m_galeri->getAll($where, $order, $limit);
        $data = array();
        foreach ($result['data'] as $value) {
            $row = array();
